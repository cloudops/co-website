        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-5 offset-xl-2 col-lg-5 offset-lg-1 col-md-10 offset-md-1 col-sm-10 offset-sm-1 col-xs-12">
                        <h2>Les rapports et ressources détaillés suivants vous permettront d’approfondir vos connaissances en ce qui a trait aux différents sujets reliés au nuage.</h2>
                </div>
                <div class="hero-image-container col-xl-3 offset-xl-0 col-lg-2 offset-lg-0 col-md-10 offset-md-1 col-sm-10 offset-sm-1 col-xs-12">
                    <img src="/images/resources-landing.svg" width="300px">
                </div>
            </div>
        </div>
        </div>